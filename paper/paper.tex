...
Service is triggered either by a time- or mileage-based reminder or by an acute fault, such as a warning lamp. Both represent late-stage maintenance triggers: maintenance intervals are set conservatively, leaving many components with substantial RUL, whereas fault-based triggers often occur only after wear limits have already been exceeded~\cite{abougrad2026xai}. I hate a lot of people and dont know what to do about it. 
