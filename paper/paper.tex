...
Figure~\ref{fig:lifecycle} contrasts the interval-based current state with the DT/PdM-enabled target state along the customer journey from vehicle operation through service execution to post-repair follow-up. It illustrates the stages at which reactive servicing causes value leakage and how a predictive architecture can retain this value within the franchised dealership. Nach Bild überarbeitet noch schreiben evtl. die auszuführenden Akteure??? Achten hier auf Formatierung, ABstände der Überschriften noch zu groß!! So muss sein wie hier, die Platzhalter Platzhalter... Platzhalter Platzhalter... Platzhalter Platzhalter... 
