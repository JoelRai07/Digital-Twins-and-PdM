...
on the order of tens of euros per vehicle per year, scaling to a six-figure
annual sum across a mid-size fleet. Compounding effects are likely given
that 90\,\% of German vehicle owners consistently return to the same
...
so fleet-lifetime totals are correspondingly optimistic. Second, the reported PdM forecast accuracy ($\approx$90\,\%, the empirical basis of A9) is stated for transparency
